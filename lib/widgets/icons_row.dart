  ...
  Widget build(BuildContext context) {
    return Row(
      children: [
        ...
        IconButton(onPressed: () {}, icon: Icon(Icons.favorite_border, color: primaryColor), iconSize: 30,),
        IconButton(onPressed: () {}, icon: Icon(Icons.volume_up, color: primaryColor), iconSize: 30,),
      ],
